;(function (global) {
  ...
  const dom = {
    ...
    /* MCP 服务器 */
    mcpList: byId('mcp-list'),
    mcpAddBtn: byId('mcp-add-btn'),
    mcpReloadBtn: byId('mcp-reload-btn'),
    mcpForm: byId('mcp-form'),
    mcpName: byId('mcp-name'),
    mcpTransport: byId('mcp-transport'),
    mcpCommand: byId('mcp-command'),
    mcpArgs: byId('mcp-args'),
    mcpUrl: byId('mcp-url'),
    mcpCommandRow: byId('mcp-command-row'),
    mcpUrlRow: byId('mcp-url-row'),
    mcpSaveBtn: byId('mcp-save-btn'),
    mcpCancelBtn: byId('mcp-cancel-btn'),
